...
def preprocess_dataset_with_col_transformer(data_loader: BaseDataLoader, column_transformer: ColumnTransformer,
    ...
    if train_set_subsample_size is not None:
        extra_shift = 42
        X_train_val = X_train_val.sample(train_set_subsample_size, random_state=dataset_split_seed + extra_shift)
        y_train_val = y_train_val.sample(train_set_subsample_size, random_state=dataset_split_seed + extra_shift)
