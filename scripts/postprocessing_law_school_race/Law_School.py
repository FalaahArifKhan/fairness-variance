...
from virny.datasets import ACSIncomeDataset, LawSchoolDataset
...
config_yaml_path = os.path.join(ROOT_DIR, 'scripts', EXPERIMENT_NAME, 'law_school_config.yaml')
...
if __name__ == '__main__':
    ...
    print('data_loader.X_data.shape:', data_loader.X_data.shape)
